...
public class MainGameScript extends SurfaceView implements SurfaceHolder.Callback {
    ...
    //GameState variable: 1 = main menu, 2 = in game, 3 = end game screen, 4 = style menu;
    ...
    public MainGameScript(Context context, GoogleApiClient googleApiClient){
        super(context);
        ...
        //soundId = soundPool.load(getContext(), R.raw.music2, 1);
    ...
    public void surfaceCreated(SurfaceHolder holder){
        ...
        mainMenuElements.add(new TextButton(Globals.GAME_WIDTH/2, 600, 50, "Play", Paint.Align.CENTER, true, 2, getContext()));
        mainMenuElements.add(new TextButton(Globals.GAME_WIDTH/2, 800, 50, "Style!", Paint.Align.CENTER, true, 4, getContext()));
        mainMenuElements.add(new TextButton(Globals.GAME_WIDTH/2, 1000, 50, "Highscores", Paint.Align.CENTER, true, 0, getContext()));
...
//    @Override
//    protected Parcelable onSaveInstanceState(Bundle savedInstanceState) {
//        savedInstanceState.putInt(YourSurfaceViewClass.SOME_ID, surfaceViewClass.getVar());
...
//    }
    ...
    public void checkBoundariesCollisions(){
        ...
        if ((player.x - player.width/2) < Globals.BOUNDARY_WIDTH){
            ...
            player.setSpeedX(-player.speedX * 0.6);
            ...
            player.setSpeedY(-player.speedY * 0.6);
...
//                }
    ...
    public void draw(Canvas canvas){
        ...
        //final float scaleFactorX = getWidth()/(Globals.GAME_WIDTH * 1.0f);
        //final float scaleFactorY = getHeight() / (Globals.GAME_HEIGHT * 1.0f);
        ...
        switch (gameState){
            ...
            case 2:
                player.draw(canvas);
                spawner.draw(canvas);
                TextButton score = new TextButton(Globals.BOUNDARY_WIDTH + 10, Globals.BOUNDARY_WIDTH + 40, 35, "Score: " + currentScore, Paint.Align.LEFT, false, 0, context);
                score.draw(canvas);
                if (nextGameState == 3){
                    for (TextButton button: gameOverMenuElements){
